/* i-C-a */
$(function(){
  var zoom1 = new ZoomView('#circleslider','#circleslider :first');
});
    ...
    */
    ...
    function DragView(target) {
      ...
      this.OnDragEnd = function(event) {
        ...
        if(position.left < 390) { //balhin na
          $(target).animate({'left':'300px'}, 500);
          $('#craters_manicouagan_active').fadeIn(500);
          $('#craters_mind_blowing_active').fadeOut(500);
        } else if(position.left >= 390 && position.left <= 610){ //i-uli sa
          $(target).animate({'left':'500px'}, 500);
          $('#craters_manicouagan_active').fadeOut(500);
          $('#craters_mind_blowing_active').fadeOut(500);
        } else {
          $(target).animate({'left':'700px'}, 500);
          $('#craters_manicouagan_active').fadeOut(500);
          $('#craters_mind_blowing_active').fadeIn(500);
        }
